...
public class SwingUITrayIcon implements IUITrayIcon {
    ...
    /**
     * Create and show the tray icon, making sure that all events are passed to
     * the provided {@link AppTrayIcon}.
     */
    public SwingUITrayIcon(AppTrayIcon appTrayIcon) {
        _appTrayIcon = appTrayIcon;
        _trayIcon = new java.awt.TrayIcon(createImage(), null /* no tooltip yet */,
                createPopUpMenu());
